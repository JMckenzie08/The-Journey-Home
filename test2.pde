...
void setup() {
  ...
  backgroundImages[2] = loadImage("city.jpg");
  backgroundImages[2].resize(1600, 900);
  backgroundImages[3] = loadImage("wasteland.png");
  backgroundImages[3].resize(1600, 900);
  storyImage2 = loadImage("level1.png");
  storyImage2.resize(1600, 900);
  deathImage = loadImage("deathscreen.png");
  level3bg = loadImage("preview_level4.png");
  level3bg.resize(1600, 900);
  bossCutsceneImgs[0] = loadImage("cutscene4.png");
  bossCutsceneImgs[1] = loadImage("cutscene5.png");
  bossCutsceneImgs[2] = loadImage("cutscene3.png");
  ...
  levelPreviews[0] = loadImage("preview_level1.png");
  levelPreviews[1] = loadImage("preview_level2.png");
  levelPreviews[2] = loadImage("preview_level3.png");
  ...
  textFont(buttonFont);
  bossGrass = loadImage("boss_grass.png");
...
void loadLevel(int levelNum) {
  ...
  if (levelNum == 0) {
    ...
    grassImg = loadImage("road.png");
    platImg = loadImage("platform2.png");
    bounceImg = loadImage("bounce.png");
    solidImg = loadImage("grass4.png");
