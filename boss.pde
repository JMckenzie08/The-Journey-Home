class Boss {
  ...
  Boss(float startX, float startY) {
    ...
    for (int i = 0; i < idleFrames.length; i++) {
      idleFrames[i] = loadImage("boss/boss_idle" + (i+1) + ".png");
    }
    for (int i = 0; i < attackFrames.length; i++) {
      attackFrames[i] = loadImage("boss/boss_attack" + (i+1) + ".png");
    }
    // load phase2 textures
    fireTexture1 = loadImage("boss/boss_attack_phase1.png");
    fireTexture2 = loadImage("boss/boss_attack_phase2.png");
    // load phase3 fall
